 ...
 */
#ifndef XROSSBOARDIMAGEVIEWER_HPP_
#define XROSSBOARDIMAGEVIEWER_HPP_
 ...
 */
//class XrossBoardImageViewer : public wxDialog {
class XrossBoardImageViewer : public wxFrame {

public:

     /// constructor
     XrossBoardImageViewer(wxWindow* parent, int id, const wxString& title,
...
private:
     ...
     /// Copy constructor
     XrossBoardImageViewer(const XrossBoardImageViewer& rhs);
     /// Assignment operator
     XrossBoardImageViewer& operator=(const XrossBoardImageViewer& rhs);
...
#endif /* XROSSBOARDIMAGEVIEWER_HPP_ */
