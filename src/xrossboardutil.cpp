 ...
 */
wxString XrossBoardUtil::GetHTTPCommTimeFromHeader(wxString& headerPath) {
     // HTTPヘッダファイルを読み込む
 ...
 */
wxString XrossBoardUtil::CalcThreadCreatedTime(wxString& threadNum) {
 ...
 */
size_t XrossBoardUtil::GetFileSize(const wxString& filePath) {
...
int XrossBoardUtil::WriteToWxString(void* context, const char* buffer, int len) {
     wxString* t = static_cast<wxString*>(context);
     *t += wxString(buffer, wxConvUTF8, len);
     return len;
}

void XrossBoardUtil::CloseWxString(void* context) {
     wxString* t = static_cast<wxString*>(context);
 ...
 */
wxString XrossBoardUtil::ReplaceURLText(const wxString& responseText) {
 ...
 */
void XrossBoardUtil::AddImgTag(wxString& responseText) {
 ...
 */
wxString XrossBoardUtil::AddAnchorTag(wxString& responseText) {
 ...
 */
wxString XrossBoardUtil::AddID(const wxString& responseText) {
 ...
 * 現在時刻をUNIX Timeで返す
 */
wxString XrossBoardUtil::GetTimeNow() {
 ...
 * 文字列をURLエンコードする
 */
std::string XrossBoardUtil::UrlEncode(const std::string& str) {
 ...
 * 文字列中の実体参照文字を変換する
 */
wxString XrossBoardUtil::ConvCharacterReference(wxString& inputString) {
 ...
 * URIから各パラメーターを抜き取る
 */
bool XrossBoardUtil::SubstringURI(const wxString& uri, PartOfURI* partOfUri) {
...
void XrossBoardUtil::SetXrossBoardProperties(const wxString& key, const T& value) {
     ...
     const wxString configFile = xbDir.GetName() + wxFILE_SEP_PATH + wxT("prop") + wxFILE_SEP_PATH + APP_CONFIG_FILE;
     wxFileConfig* config = new wxFileConfig(wxT("XrossBoard"), wxEmptyString, configFile, wxEmptyString, wxCONFIG_USE_LOCAL_FILE);
...
// テンプレート関数の実体化
template void XrossBoardUtil::SetXrossBoardProperties<wxString>(const wxString& key, const wxString& value);
template void XrossBoardUtil::SetXrossBoardProperties<long>(const wxString& key, const long& value);
template void XrossBoardUtil::SetXrossBoardProperties<double>(const wxString& key, const double& value);
template void XrossBoardUtil::SetXrossBoardProperties<bool>(const wxString& key, const bool& value);
/**
...
// テンプレート関数の実体化
template void XrossBoardUtil::GetXrossBoardProperties<wxString>(const wxString& key, wxString* value);
template void XrossBoardUtil::GetXrossBoardProperties<long>(const wxString& key, long* value);
template void XrossBoardUtil::GetXrossBoardProperties<double>(const wxString& key, double* value);
template void XrossBoardUtil::GetXrossBoardProperties<bool>(const wxString& key, bool* value);
 ...
 */
wxString XrossBoardUtil::ProcessFirstResponse(wxString& threadRecord) {
 ...
 * スレッドの１以降を処理するメソッド
 */
wxString XrossBoardUtil::ProcessRestResponse(wxString& threadRecord, int number) {
 ...
 */
void XrossBoardUtil::SplitStdString(std::vector<std::string>& theStringVector,	/* Altered/returned value */
